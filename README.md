<h1>Schemer — Android приложение для управления проектами</h1>
Удобный инструмент для ведения проектов: задачи, идеи, описание, сценарии — всё в одном месте.
Идеально подходит для студентов, фрилансеров, разработчиков и всех, кто хочет структурировать свои мысли и задачи.
<h2>Основные возможности</h2>
<ul>
  <li>Создание и удаление проектов</li>
  <li>У каждого проекта — 5 разделов:</li>
  <ul>
    <li><b>Задачи</b> — добавляйте, вычеркивайте, удаляйте задачи.</li>
    <li><b>Описание</b> — краткое или подробное описание проекта.</li>
    <li><b>Идеи</b> — блоки свободных размышлений.</li>
    <li><b>Сценарий</b> — описание работы с приложением.</li>
    <li><b>Настройки</b> — переименование проекта и отключение ненужных панелей.</li>
  </ul>
  <li>Автоматическое скрытие проектов при повороте устройства (для конфиденциальности или удобства).</li>
</ul>
<h2>Технологии</h2>
Язык программирования - <em>Kotlin</em>.<br>
База данных - <em>SQLite</em>.
